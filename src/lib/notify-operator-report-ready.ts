            ...
            <tr>
              <td style="padding:0 32px 14px;">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;background:#fafafa;border:1px solid #ececec;border-radius:6px;">
                  ...
                  <tr><td style="padding:8px 14px;color:#666;font-size:13px;border-top:1px solid #ececec;vertical-align:top;">Website</td><td style="padding:8px 14px;color:#1a1a1a;font-size:12.5px;line-height:1.5;border-top:1px solid #ececec;word-break:break-all;overflow-wrap:anywhere;font-family:ui-monospace,SFMono-Regular,'SF Mono',Menlo,Consolas,monospace;"><span style="display:inline-block;max-width:100%;word-break:break-all;overflow-wrap:anywhere;">${sw}</span></td></tr>
